...
namespace StjacksAssistens.Controllers
{
    public class HomeController : Controller
    {
        ...
        // Horas ausentes de un estado. Si el registro no trae horas/minutos,
        // se considera falta de jornada completa (8.5 h), como en el Excel.
        ...
        // Anónimo: si un error ocurre antes de iniciar sesión, la página de error debe poder mostrarse
        [AllowAnonymous]
